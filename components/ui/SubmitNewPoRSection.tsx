import { Button, Input, Modal, ModalBody, ModalContent, ModalFooter, ModalOverlay, Select, Stack, Text, useDisclosure } from '@chakra-ui/react'
...
transparent ecosystem in Filecoin.</Text>
    ...
    <Stack width={'387px'} minHeight={'382px'} align={'center'} borderRadius={'20px'} padding={'18px 20px'} justify={'space-around'} boxShadow={'0px 4px 20px 0px rgba(189, 236, 241, 0.5)'} gap={'14px'}>
        ...
        <Button onClick={onOpen} leftIcon={<PlusWhiteIcon />} bgGradient={'linear(to-r, #127FC9, #12C99D)'} width={'100%'} borderRadius={'50px'} p={'0px 20px'} color={'white'}>Submit Proof Reserve</Button>
    </Stack>
    </>
  )
}
